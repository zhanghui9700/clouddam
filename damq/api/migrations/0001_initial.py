    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('transactionType', models.IntegerField(default=0, verbose_name='Transaction Type', choices=[(0, 'New Transaction'), (1, 'Delete Transaction'), (2, 'Update Transaction'), (3, 'Update Cert'), (4, 'Add IP'), (5, 'Delete IP'), (6, 'Update Domain')])),
